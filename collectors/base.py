...
from shared.persist import (
    ...
    get_cursor, set_cursor, log_run, InsertResult
)
...
class BaseCollector:
    ...
    def parse(self, raw_content: bytes, raw_hash: str) -> CollectorResult:
        raise NotImplementedError
    ...
    def run(self) -> CollectorResult:
        ...
        try:
            ...
            raw_hash = store_raw(raw_content, self.SOURCE_ID)
            store_acquisition(self.SOURCE_ID, self.DATASET, self.SOURCE_ID, 200, raw_hash,
        ...
        log_run(self.SOURCE_ID, 'ok' if not result.errors else 'error',
                ...
                result.records_new, result.records_unchanged, result.records_invalid,
